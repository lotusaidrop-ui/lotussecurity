...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lotus Security — Cyber Risk Audits" },
      {
        name: "description",
        content:
          "External, non-invasive Cyber Risk Audits for professional service firms, delivered in 24–72 hours.",
      },
      { name: "author", content: "Lotus Security" },
      { property: "og:title", content: "Lotus Security — Cyber Risk Audits" },
      {
